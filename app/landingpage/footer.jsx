      ...
      <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
        ...
        >
          ...
          <div style={{ maxWidth: "260px" }}>
            ...
            <p style={{ fontSize: "0.92rem", color: "#aaa", lineHeight: 1.7, margin: 0 }}>
              AI-powered writing assistant for students, writers, professionals, and researchers.
              ...
              {socials.map((s) => (
                <a
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.borderColor = "#E9E4FF";
                    e.currentTarget.style.background = "rgba(233,228,255,0.08)";
                  }}
                  onMouseLeave={(e) => {
